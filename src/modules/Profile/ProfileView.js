					...
					<View style={{flex: 1}}>
						<View style={styles.cardProfile}>
							<View style={styles.profile}>
								<Image source={{uri: this.state.photo}} style={styles.profilePhoto} />
						...
						<View style={styles.cardSetting}>
							<ListItem
								...
								chevron={<Switch value={this.state.isLanguageTH} onValueChange={isLanguageTH => this.onSelectedLanguageTh(isLanguageTH)} />}
							/>
							<ListItem containerStyle={{borderRadius: 10}} title={I18n.t('placeholder.appVersion')} chevron={<Text>0.0.1</Text>} />
						</View>
