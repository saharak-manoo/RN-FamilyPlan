...
import {Alert, View, Dimensions, Platform, TouchableOpacity, Modal, ScrollView, StatusBar} from 'react-native';
			...
			<View style={{flex: 1}}>
				...
				<ScrollView style={{flex: 1}}>
					...
					<View style={{padding: 15}}>
						...
						/>
						<HelperText type="error" visible={GFunction.validateBlank(this.state.firstName)}>
						...
						/>
						<HelperText type="error" visible={GFunction.validateBlank(this.state.lastName)}>
						...
						/>
						<HelperText type="error" visible={GFunction.validateEmail(this.state.email)}>
						...
						/>
						<HelperText type="error" visible={GFunction.validatePhoneNumber(this.state.phoneNumber)}>
						...
						/>
						<HelperText type="error" visible={GFunction.validatePasswordLessThanSix(this.state.password)}>
						...
						/>
						<HelperText type="error" visible={GFunction.validatePasswordMatch(this.state.password, this.state.confirmPassword)}>
